...
import static org.zalando.planb.provider.config.properties.ScopeProperties.SPACE;
...
public class UpstreamUserRealm implements UserRealm {
    ...
    public String getAccessToken(String username, String password, Set<String> scopes) {
    ...
    public UpstreamTokenResponse getTokenInfo(String username, String token) {
