...
import org.zalando.planb.provider.api.dto.OIDCDiscoveryInformationResponse;
import org.zalando.planb.provider.config.RealmConfig;
import org.zalando.planb.provider.config.properties.ScopeProperties;
import org.zalando.planb.provider.dto.AuthorizationCode;
import org.zalando.planb.provider.dto.ClientCredentials;
import org.zalando.planb.provider.dto.ClientData;
import org.zalando.planb.provider.exceptions.*;
...
import org.zalando.planb.provider.metrics.Metric;
...
import org.zalando.planb.provider.services.OIDCKeyHolder;
...
import static org.zalando.planb.provider.metrics.Metric.trimSlash;
...
public class OIDCController {
    ...
    public static String getRealmName(RealmConfig realms, Optional<String> realmNameParam, Optional<String> hostHeader) {
